...
|---|---|---|---|---|
| **L1** | Global Load Sectors | 3,932,160 | 3,145,728 | v3 多读了 786,432 sectors（=多一趟 input） |
| **L1** | → Miss 到 L2 Sectors | 1,633,144 | 1,256,888 | v3 多发 376,256 到 L2 |
| **L2** | 收到的 Load Sectors | 1,633,480 | 1,261,004 | v3 多收 372,476 |
| **L2** | Hit Rate | 51.45% | 37.60% | v3 命中率更高 |
